...
import { SelectMenuOption } from "./countryTypes";
...
export interface CountrySelectorProps {
  ...
  disabled?: boolean;
  onToggle: () => void;
  onChange: (isoCode: SelectMenuOption["isoCode"]) => void;
              ...
              <div className="sticky top-0 z-10 bg-white">
                <li className=" text-gray-900 cursor-default select-none relative py-2 px-3">
                  <input
                    ...
                    name="search"
                    autoComplete={"off"}
                    className="focus:ring-blue-500 h-8 px-2 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                  ...
                  COUNTRIES.filter((country) =>
                    ...
                    return (
                      ...
                      >
                        <img
                          alt={`${country.isoCode}`}
                          src={`https://purecatamphetamine.github.io/country-flag-icons/3x2/${country.isoCode}.svg`}
                          className={"inline mr-2 h-4 rounded-sm"}
                        />
